...
// this fork exists to drop the .wikicommit/wiki/<lang>/ segment that would
...
// .wikicommit/wiki/<lang>/<Type>/<slug>.md is mirrored 1:1 into
...
// outside the .wikicommit/wiki/<lang>/ layout) is left untouched instead of
