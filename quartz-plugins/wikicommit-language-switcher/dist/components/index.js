...
var WikiCommitLanguageSwitcher = ({
  ...
  const entries = [...siblings.entries()].sort(([a2], [b2]) => a2.localeCompare(b2)).map(([lang, slug2]) => ({
    lang,
    href: lang === current.lang ? "" : resolveRelative(currentSlug, slug2),
