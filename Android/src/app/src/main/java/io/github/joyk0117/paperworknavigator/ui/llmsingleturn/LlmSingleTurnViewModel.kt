...
package io.github.joyk0117.paperworknavigator.ui.llmsingleturn

import android.util.Log
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import io.github.joyk0117.paperworknavigator.common.processLlmResponse
    ...
    viewModelScope.launch(Dispatchers.Default) {
      ...
      val supportImage =
        model.llmSupportImage &&
          task.id == io.github.joyk0117.paperworknavigator.data.BuiltInTaskId.LLM_ASK_IMAGE
      val supportAudio =
        model.llmSupportAudio &&
          task.id == io.github.joyk0117.paperworknavigator.data.BuiltInTaskId.LLM_ASK_AUDIO
