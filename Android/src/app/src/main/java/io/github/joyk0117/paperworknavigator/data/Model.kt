...
data class Model(
   ...
   * - `io.github.joyk0117.paperworknavigator` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/io.github.joyk0117.paperworknavigator/files/my_model/local_dir/
   *
