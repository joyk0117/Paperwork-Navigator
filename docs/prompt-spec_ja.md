...
*v0.2.5: MF-07 チャットタイムアウトを 20 秒から 60 秒に延長（Translator・OcrCorrector と統一）。応答制約を `Keep each response under 3 sentences.` から `Limit your reply to 1–2 sentences.` に強化（3 文でも日本語で 150 字超になり得るため）。§7.1 System Prompt・§7.1 maxOutputTokens 注記・§10.4 TC-07-10/TC-07-11 を更新。*
